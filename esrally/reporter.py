...
class ComparisonReporter:
    ...
    def write_report(self, metrics_table):
        ...
        self.write_single_report(report_file, headers=["Metric", "Operation", "Baseline", "Contender", "Diff", "Unit"], data= self.metrics_table(baseline_stats, contender_stats), write_header=True)
